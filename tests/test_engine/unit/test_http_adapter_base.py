...
class _MinimalAdapter:
    """Concrete stub satisfying every abstract method."""
...
def _build_minimal_class():
    ...
    return type("MinimalAdapter", (AbstractHttpAdapter, _MinimalAdapter), {})
...
def test_all_abstract_methods_are_listed():
    ...
    import inspect
    abstract_methods = {
        name for name, method in inspect.getmembers(AbstractHttpAdapter)
